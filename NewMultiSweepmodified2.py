...
def find_optimum_wavelength(matdict, guess_wavelength=1550e-9,range=2e-9):
    ...
    power3 = np.array(matdict['power3'])   # retrieving the values for the power3 channel. (dBm)
    power4 = np.array(matdict['power4'])   # retrieving the values for the power4 channel. (dBm)
    power5 = np.array(matdict['power5'])  # retrieving the values for the power5 channel. (dBm)
    power6 = np.array(matdict['power6'])  # retrieving the values for the power6 channel. (dBm)
    ...
    combo_power = np.add(power1,power2,power3,power4,power5,power6)[st_index:end_index]
...
def run_fine_align(laser, stage, optimum_wavelength=1550e-9):
    """
...
if __name__ == '__main__':
    ...
    baseFolder = 'C:/Users/MapleLeafStage/Documents/Mar29Trial/'
