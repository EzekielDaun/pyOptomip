...
if __name__ == '__main__':
   ...
   # laser.connect('GPIB0::20::INSTR', reset=0, forceTrans=1) ## This is the address of the GPIB cable we are using,from NI MAX
    ...
    baseFolder = 'C:/Users/MapleLeafStage/Documents/Vinny/2022-06-02_Gemina-Phase-3b_Trial-1/Bioassay/'
    ...
    laser.sweepStepWvl = 8e-12;  # step size
